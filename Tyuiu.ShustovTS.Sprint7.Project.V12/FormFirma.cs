...
namespace Tyuiu.ShustovTS.Sprint7.Project.V12
{
    public partial class FormFirma : Form
    {
        ...
        {
            InitializeComponent();
            dataGridViewInFirma_STS.DataSource = ReadCSVFile($@"{Directory.GetCurrentDirectory()}\InPutFirma_Sprint7.csv");
        }
        ...
        private void buttonClose_STS_Click(object sender, EventArgs e)
        {
            this.Close();
        }
    }
